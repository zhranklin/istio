...
var KnownTypes = map[string]SchemaType{
	...
	model.VersionManager.Type: {
		Schema: model.VersionManager,
		Object: &VersionManager{
			TypeMeta: meta_v1.TypeMeta{
				Kind:       "VersionManager",
				APIVersion: APIVersion(&model.VersionManager),
			},
		},
		Collection: &VersionManagerList{},
	},
}
...
// VersionManager is the generic Kubernetes API object wrapper
...
// GetSpec from a wrapper
func (in *VersionManager) GetSpec() map[string]interface{} {
	return in.Spec
}

// SetSpec for a wrapper
func (in *VersionManager) SetSpec(spec map[string]interface{}) {
	in.Spec = spec
}

// GetObjectMeta from a wrapper
func (in *VersionManager) GetObjectMeta() meta_v1.ObjectMeta {
	return in.ObjectMeta
}

// SetObjectMeta for a wrapper
func (in *VersionManager) SetObjectMeta(metadata meta_v1.ObjectMeta) {
	in.ObjectMeta = metadata
}

// VersionManagerList is the generic Kubernetes API list wrapper
type VersionManagerList struct {
	meta_v1.TypeMeta `json:",inline"`
	meta_v1.ListMeta `json:"metadata"`
	Items            []VersionManager `json:"items"`
}

// GetItems from a wrapper
func (in *VersionManagerList) GetItems() []IstioObject {
	out := make([]IstioObject, len(in.Items))
	for i := range in.Items {
		out[i] = &in.Items[i]
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VersionManager) DeepCopyInto(out *VersionManager) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VersionManager.
func (in *VersionManager) DeepCopy() *VersionManager {
	if in == nil {
		return nil
	}
	out := new(VersionManager)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *VersionManager) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VersionManagerList) DeepCopyInto(out *VersionManagerList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]VersionManager, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VersionManagerList.
func (in *VersionManagerList) DeepCopy() *VersionManagerList {
	if in == nil {
		return nil
	}
	out := new(VersionManagerList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *VersionManagerList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
