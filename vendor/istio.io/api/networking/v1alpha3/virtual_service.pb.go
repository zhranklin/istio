...
type TransformedRequest_BodyType int32

const (
	TransformedRequest_Passthrough           TransformedRequest_BodyType = 0
	TransformedRequest_Body                  TransformedRequest_BodyType = 1
	TransformedRequest_MergeExtractorsToBody TransformedRequest_BodyType = 2
)

var TransformedRequest_BodyType_name = map[int32]string{
	0: "Passthrough",
	1: "Body",
	2: "MergeExtractorsToBody",
}

var TransformedRequest_BodyType_value = map[string]int32{
	"Passthrough":           0,
	"Body":                  1,
	"MergeExtractorsToBody": 2,
}

func (x TransformedRequest_BodyType) String() string {
	return proto.EnumName(TransformedRequest_BodyType_name, int32(x))
}

func (TransformedRequest_BodyType) EnumDescriptor() ([]byte, []int) {
...
type RequestTransformation struct {
	...
	New                  *TransformedRequest `protobuf:"bytes,2,opt,name=new,proto3" json:"new,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *RequestTransformation) GetNew() *TransformedRequest {
	if m != nil {
		return m.New
	}
	return nil
...
type TransformedRequest struct {
	Param                *Parameters                 `protobuf:"bytes,1,opt,name=param,proto3" json:"param,omitempty"`
	Bodytype             TransformedRequest_BodyType `protobuf:"varint,2,opt,name=bodytype,proto3,enum=istio.networking.v1alpha3.TransformedRequest_BodyType" json:"bodytype,omitempty"`
...
func (m *TransformedRequest) Reset()         { *m = TransformedRequest{} }
func (m *TransformedRequest) String() string { return proto.CompactTextString(m) }
func (*TransformedRequest) ProtoMessage()    {}
func (*TransformedRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_e85a9a4fa9c17a22, []int{4}
}
func (m *TransformedRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TransformedRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TransformedRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *TransformedRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TransformedRequest.Merge(m, src)
}
func (m *TransformedRequest) XXX_Size() int {
	return m.Size()
}
func (m *TransformedRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_TransformedRequest.DiscardUnknown(m)
}

var xxx_messageInfo_TransformedRequest proto.InternalMessageInfo

func (m *TransformedRequest) GetParam() *Parameters {
	if m != nil {
		return m.Param
	}
	return nil
...
func (m *TransformedRequest) GetBodytype() TransformedRequest_BodyType {
	if m != nil {
		return m.Bodytype
	}
	return TransformedRequest_Passthrough
}

func (m *TransformedRequest) GetText() string {
	if m != nil {
		return m.Text
	}
	return ""
...
func (*Headers_HeaderOperations) Descriptor() ([]byte, []int) {
	return fileDescriptor_e85a9a4fa9c17a22, []int{8, 0}
}
...
func (*HTTPFaultInjection_Delay) Descriptor() ([]byte, []int) {
	return fileDescriptor_e85a9a4fa9c17a22, []int{21, 0}
}
...
func (*HTTPFaultInjection_Abort) Descriptor() ([]byte, []int) {
	return fileDescriptor_e85a9a4fa9c17a22, []int{21, 1}
}
...
func init() {
	proto.RegisterEnum("istio.networking.v1alpha3.TransformedRequest_BodyType", TransformedRequest_BodyType_name, TransformedRequest_BodyType_value)
	...
	proto.RegisterType((*TransformedRequest)(nil), "istio.networking.v1alpha3.TransformedRequest")
...
var fileDescriptor_e85a9a4fa9c17a22 = []byte{
	...
	,
}
...
func (m *TransformedRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TransformedRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Param != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintVirtualService(dAtA, i, uint64(m.Param.Size()))
		n15, err := m.Param.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
	...
	if m.Bodytype != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintVirtualService(dAtA, i, uint64(m.Bodytype))
	}
	if len(m.Text) > 0 {
		dAtA[i] = 0x1a
		i++
...
func (m *HTTPMatchRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Scheme != nil {
		...
		n21, err := m.Scheme.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
	...
	if m.Authority != nil {
		...
		n23, err := m.Authority.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
...
func (m *HTTPRouteDestination) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Destination != nil {
		...
		n25, err := m.Destination.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n25
	...
	if m.Headers != nil {
		...
		i++
		i = encodeVarintVirtualService(dAtA, i, uint64(m.Headers.Size()))
		n26, err := m.Headers.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
...
func (m *StringMatch) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.MatchType != nil {
		nn28, err := m.MatchType.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn28
...
func (m *HTTPRetry) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PerTryTimeout != nil {
		...
		n29, err := m.PerTryTimeout.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n29
...
func (m *CorsPolicy) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MaxAge != nil {
		...
		n30, err := m.MaxAge.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
	...
	if m.AllowCredentials != nil {
		...
		n31, err := m.AllowCredentials.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n31
...
func (m *HTTPFaultInjection) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Delay != nil {
		...
		n32, err := m.Delay.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
	...
	if m.Abort != nil {
		...
		n33, err := m.Abort.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n33
...
func (m *HTTPFaultInjection_Delay) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.HttpDelayType != nil {
		nn34, err := m.HttpDelayType.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn34
	...
	if m.Percentage != nil {
		...
		n35, err := m.Percentage.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n35
...
func (m *HTTPFaultInjection_Delay_FixedDelay) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.FixedDelay != nil {
		...
		n36, err := m.FixedDelay.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
...
func (m *HTTPFaultInjection_Delay_ExponentialDelay) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ExponentialDelay != nil {
		...
		n37, err := m.ExponentialDelay.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
...
func (m *HTTPFaultInjection_Abort) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ErrorType != nil {
		nn38, err := m.ErrorType.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn38
	...
	if m.Percentage != nil {
		...
		i++
		i = encodeVarintVirtualService(dAtA, i, uint64(m.Percentage.Size()))
		n39, err := m.Percentage.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
...
func (m *PortSelector) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Port != nil {
		nn40, err := m.Port.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn40
...
func (m *TransformedRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.Bodytype != 0 {
		n += 1 + sovVirtualService(uint64(m.Bodytype))
	}
	l = len(m.Text)
	if l > 0 {
		n += 1 + l + sovVirtualService(uint64(l))
...
func (m *TransformedRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TransformedRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TransformedRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Bodytype |= TransformedRequest_BodyType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
