...
_HTTPROUTE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='IncludeVhRateLimits', full_name='istio.networking.v1alpha3.HTTPRoute.IncludeVhRateLimits', index=22,
