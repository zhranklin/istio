...
type RateLimitServiceConfig struct {
	...
	StaticConfig         string            `protobuf:"bytes,4,opt,name=static_config,json=staticConfig,proto3" json:"static_config,omitempty"`
...
func (m *RateLimitServiceConfig) GetStaticConfig() string {
	if m != nil {
...
var fileDescriptor_3154ecf621be8917 = []byte{
	...
	,
}
...
func (m *RateLimitServiceConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.StaticConfig) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintRls(dAtA, i, uint64(len(m.StaticConfig)))
		i += copy(dAtA[i:], m.StaticConfig)
	}
...
func (m *RateLimitServiceConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.StaticConfig = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
